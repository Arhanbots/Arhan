...
async def gen_thumb(videoid: str):
    ...
    try:
        ...
        arial = ImageFont.truetype("VILLAIN_MUSIC/assets/font2.ttf", 30)

        font = ImageFont.truetype("VILLAIN_MUSIC/assets/font.ttf", 30)

        title_font = ImageFont.truetype("VILLAIN_MUSIC/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("VILLAIN_MUSIC/assets/play_icons.png")
